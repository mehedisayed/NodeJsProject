...
module.exports= {
	getAll : function(callback){
		var sql = "select * from users u,usertype ut where u.usertypeid=ut.usertypeid and ut.usertypename ='branch_manager'";
	...
	getAllUserType : function(callback){
		var sql = "select * from usertype where usertypename!='customer' and usertypename='employee'";
		db.getResults(sql, null, function(results){
			if(results.length > 0){
				callback(results);
			}else{
